...
MS CSE @ Santa Clara University | SWE Intern @ Google
----------------------------------------------------------------------------

Others:
- Grader @ Santa Clara University (Web Infrastructure, Secure Coding in C/C++, Object Oriented Design, Analysis, and Programming)
- Full Stack Developer @ SCU HCI Lab
- Full Stack Mobile Developer @ SCU EPIC Lab
- Prev. SWE Intern @ Anritsu
